...
<body class="bg-gray-100 flex justify-center items-center h-screen">
    <div class=" mx-auto">
        <div class="max-w-md bg-white p-8 rounded-lg shadow-md">
            ...
            <script src="https://unpkg.com/@dotlottie/player-component@latest/dist/dotlottie-player.mjs" type="module"></script><dotlottie-player src="https://lottie.host/817b9ff1-4a20-4595-ba0a-f79130313a69/WXjo81RdHX.json" background="#fff" speed="1" style="width: 300px; height: 300px" direction="1" playMode="normal" loop autoplay></dotlottie-player>
